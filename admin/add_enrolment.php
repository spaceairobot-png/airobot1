...
$query = "SELECT A.* , B.Des FROM tblstudent A 
          LEFT JOIN cfgcounsellor B ON A.Counsellors = B.code 
          WHERE A.Id='" . $_GET['stuId'] . "' LIMIT 1";
...
<h1 class="page-header">Add New Enrolment</h1>
<form method="post" onkeypress="return event.keyCode != 13;">
	...
	<div class="row" style="margin-top:10px">
		...
		<div class="col-sm-5"> 
		<input type="text" class="datepicker form-control " id="dtPick2" name="txtdate_intake" value="<?php if(! isset($r["Intake"])) {echo date('d/m/Y', strtotime(date("Y/m/d")));} else{ echo $r["Intake"]; } ?>"  style="width:50%; margin-right:1%; display:inline;" autocomplete="off" required><span class="glyphicon glyphicon-calendar" ></span></div> 
	</div>
	...
	<div class="row" style="margin-top:10px">
		...
		<div class="col-sm-5">
		<input type="text" value="<?php echo $r["Remark"]; ?>" name="txtRemark" class="form-control" /></div>
	</div>
